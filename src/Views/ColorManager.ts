...
export class ColorManager {
	...
	static apply(el: HTMLElement, name: keyof typeof ColorManager.COLOR_MAP, channel = 'c') {
	...
	static applyBorderLine(el: HTMLElement, name: string, channel = 'c') {
		const color = this.COLOR_MAP[name];
	...
	static applyCustom(el: HTMLElement, color: LightDarkColor, channel = 'c') {
		el.classList.add('has-plugin-color');
